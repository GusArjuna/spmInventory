              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="/login">
                    @csrf
                    <div class="mb-3">
                      <input type="text" class="form-control form-control-lg @error('username') is-invalid @enderror" placeholder="username" aria-label="username" name="username" value="{{ old('username') }}" autofocus required>
                    </div>
                    <div class="mb-3">
