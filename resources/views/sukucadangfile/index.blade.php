  ...
  <div class="col-12">
    <div class="card mb-4">
      <div class="card-header pb-0 d-flex justify-content-between align-items-center" style="width: 1150px">
        ...
        <a href="{{ url('/sukucadang/tambah') }}"  class="mdc-button mdc-menu-button mdc-button--raised icon-button shaped-button secondary-filled-button mr-4">
      ...
      <div class="card-body px-0 pt-0 pb-2">
        <div class="container">
          {{ $sukuCadangs->links('vendor.pagination.pagination-template') }}
        </div>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div class="d-flex flex-column justify-content-center">
                      <h6 class="mb-0 text-sm" style="padding-left: 10px;">{{ $sukuCadang->nomor }}</h6>
                    </div>
                  </div>
                </td>
                <td>
                ...
                <td class="align-middle">
                  <a href="/sukucadang/{{ $sukuCadang->id }}/edit" class="text-success font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                    Edit
                  </a>
                  |
                  <form action="/sukucadang/{{ $sukuCadang->id }}" method="post" class="d-inline">
                    @csrf
                    @method('delete')
