        ...
        <div class="container">
          <form action="" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nomor" placeholder="DC06">
            </div>
            <div class="form-group">
              <label for="nama">Nama Suku Cadang</label>
              <input type="text" class="form-control" id="nama" placeholder="Oil">
            </div>
            <div class="form-group">
              <label for="sukucadang">Jenis Suku Cadang</label>
              <select class="form-control @error('foodCategory') is-invalid @enderror" aria-label=".form-select-sm example" name="sukucadang" id="sukuCadang">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="harga" placeholder="15000">
            </div>
            <div class="form-group">
              <label for="ketersediaan">Ketersediaan</label>
              <select class="form-control @error('foodCategory') is-invalid @enderror" aria-label=".form-select-sm example" name="ketersediaan" id="ketersediaan">
