        ...
        <div class="container">
          <form action="/laporanpeminjaman/tambah" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('peminjam') is-invalid @enderror" id="peminjam" placeholder="John" name="peminjam" value="{{ old('peminjam') }}" required>
              @error('peminjam')
                      <div class="alert alert-danger" style="color: white">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="form-group">
              ...
              <input class="form-control @error('tanggalKembali') is-invalid @enderror" type="date" id="tanggalKembali" name="tanggalKembali" value="{{ old('tanggalKembali') }}">
